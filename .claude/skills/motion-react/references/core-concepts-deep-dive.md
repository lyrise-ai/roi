...
function ScrollSection() {
  ...
  return (
    <motion.div ref={ref} style={{ opacity, scale, rotate }}>
...
function ParallaxScene() {
  ...
  return (
    <div className="relative h-[200vh]">
      ...
      <motion.div className="fixed inset-0" style={{ y: midgroundY }}>
        <img src="/trees.png" />
      </motion.div>

      <motion.div className="fixed inset-0" style={{ y: foregroundY }}>
