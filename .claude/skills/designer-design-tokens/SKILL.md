...
--color-bg-primary:          /* Main background */ --color-bg-secondary:
  ...
  --color-accent-primary-hover: --color-accent-primary-active:
  --color-accent-secondary: /* Secondary action color */
  --color-status-success: --color-status-warning: --color-status-error:
  --color-status-info: --color-surface-overlay: /* Modal/dropdown backdrop */;
```
...
```css
--space-0: 0;
--space-1:   /* base * 0.25 */ --space-2: /* base * 0.5 */
  --space-3: /* base * 0.75 */ --space-4: /* base * 1 */
  --space-5: /* base * 1.5 */ --space-6: /* base * 2 */
  --space-7: /* base * 3 */ --space-8: /* base * 4 */ --space-9: /* base * 6 */
  --space-10: /* base * 8 */ --space-11: /* base * 12 */
  --space-12: /* base * 16 */;
```
...
```css
--font-family-display:       /* Headline/display font */ --font-family-body:
  /* Body text font */
  ...
  --font-weight-bold: --line-height-tight: /* Headings: 1.1-1.3 */
